...
export class KnowledgeService {
  ...
  setKnowledgeItems(): void {
    ...
    this.knowledgeList.push(new Types.KnowledgeItem(7, 'React / React Native', 'react.png', 'React'));
    ...
    this.knowledgeList.push(new Types.KnowledgeItem(11, 'GraphQL', 'graphql.png', 'GraphQL'));
