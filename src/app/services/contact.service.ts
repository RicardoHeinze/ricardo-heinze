...
export class ContactService {
  ...
  setContactItems(): void {
    ...
    this.contactList.push(new Types.Contact(2, 'E-mail', 'ricardo.heinze@hotmail.com', 'icon-email', 'mailto:ricardo.heinze@hotmail.com'));
    this.contactList.push(new Types.Contact(3, 'LinkedIn', 'ricardoheinze22', 'icon-linkedin', 'https://www.linkedin.com/in/ricardoheinze22/'));
